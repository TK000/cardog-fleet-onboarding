...
- the vehicle model year must not be more than 12 years old
...
I thought of this from a rideshare angle, and I chose rules that map directly to practical rideshare requirements: passenger capacity, vehicle age, vehicle type, and mileage.
